...
puts "🌱 Seeding spices..."
chili_peppers = Artist.create(name:"Red Hot Chili Peppers",photo_url: "https://www.pexels.com/photo/photography-of-people-playing-gutiar-1164773/", nationality: "American")
...
song3=Song.create(title: "Californication", album: "Californication",preview_url:src="https://www.youtube.com/embed/YlUKcNNmywk" ,artist_id:chili_peppers.id)
...
song5=Song.create(title: "Dark Necessities", album: "The Getaway", preview_url:"https://www.youtube.com/embed/Q0oIoR9mLwc",artist_id:chili_peppers.id)
